...
// Base URL for Dehiwala listings
const BASE_URL = 'https://ikman.lk/en/ads/dehiwala/room-annex-rentals?sort=date&order=desc&buy_now=0&urgent=0';
const OUTPUT_FILE = path.join(__dirname, 'Dehiwala_links.txt');

...
const { crawlLinks } = require('./Dehiwala_get_links');

// Configuration
const BOT_TOKEN = '8547354550:AAFZxMFWnwt9ropoxUWucM5ztME8Q860f0E';
const CHANNEL_ID = '@thueNha_srilanka_Dehiwala';
...
// File Paths
const LINKS_FILE = path.join(__dirname, 'Dehiwala_links.txt');
const HISTORY_FILE = path.join(__dirname, 'Dehiwala_sent_history.txt');
const METADATA_FILE = path.join(__dirname, 'Dehiwala_metadata.json');
...
async function runAutomation() {
    try {
        console.log("=== DEHIWALA AUTOMATION START ===");

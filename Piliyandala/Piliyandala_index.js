...
const { crawlLinks } = require('./Piliyandala_get_links');

// Configuration
const BOT_TOKEN = '8547354550:AAFZxMFWnwt9ropoxUWucM5ztME8Q860f0E';
const CHANNEL_ID = '@thueNha_srilanka_Piliyandala';
...
// File Paths
const LINKS_FILE = path.join(__dirname, 'Piliyandala_links.txt');
const HISTORY_FILE = path.join(__dirname, 'Piliyandala_sent_history.txt');
const METADATA_FILE = path.join(__dirname, 'Piliyandala_metadata.json');
...
async function runAutomation() {
    try {
        console.log("=== PILIYANDALA AUTOMATION START ===");

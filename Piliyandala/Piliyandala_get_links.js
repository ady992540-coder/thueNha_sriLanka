...
// Base URL for Piliyandala listings
const BASE_URL = 'https://ikman.lk/en/ads/piliyandala/room-annex-rentals?sort=date&order=desc&buy_now=0&urgent=0';
const OUTPUT_FILE = path.join(__dirname, 'Piliyandala_links.txt');

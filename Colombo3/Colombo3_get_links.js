...
const BASE_URL = 'https://ikman.lk/en/ads/colombo-3/room-annex-rentals?sort=date&order=desc&buy_now=0&urgent=0';
const OUTPUT_FILE = path.join(__dirname, 'Colombo3_links.txt');

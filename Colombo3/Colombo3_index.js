...
const { crawlLinks } = require('./Colombo3_get_links');

// Configuration
const BOT_TOKEN = '8547354550:AAFZxMFWnwt9ropoxUWucM5ztME8Q860f0E';
const CHANNEL_ID = '@thueNha_srilanka_Colombo3';
...
// File Paths
const LINKS_FILE = path.join(__dirname, 'Colombo3_links.txt');
const HISTORY_FILE = path.join(__dirname, 'Colombo3_sent_history.txt');
const METADATA_FILE = path.join(__dirname, 'Colombo3_metadata.json');
...
async function runAutomation() {
    try {
        console.log("=== COLOMBO3 AUTOMATION START ===");

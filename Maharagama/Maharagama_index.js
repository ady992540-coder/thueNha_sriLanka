...
const { crawlLinks } = require('./Maharagama_get_links');

// Configuration
const BOT_TOKEN = '8547354550:AAFZxMFWnwt9ropoxUWucM5ztME8Q860f0E';
const CHANNEL_ID = '@thueNha_srilanka_Maharagama';
...
// File Paths
const LINKS_FILE = path.join(__dirname, 'Maharagama_links.txt');
const HISTORY_FILE = path.join(__dirname, 'Maharagama_sent_history.txt');
const METADATA_FILE = path.join(__dirname, 'Maharagama_metadata.json');
...
async function runAutomation() {
    try {
        console.log("=== MAHARAGAMA AUTOMATION START ===");
